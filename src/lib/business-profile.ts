...
export const businessProfileFields = [
  ...
  {
    help: "Horario normal de atencion y excepciones importantes.",
    key: "business_hours",
    label: "Horarios",
  ...
  {
    help: "Direccion exacta si atiende presencialmente.",
    key: "address",
    label: "Direccion",
  ...
  {
    help: "Formas de pago aceptadas y condiciones basicas.",
    key: "payment_methods",
  ...
  {
    help: "Pais por defecto para interpretar numeros y contexto.",
    key: "country",
    label: "Pais",
    placeholder: "Espana",
    variable: "{country}",
